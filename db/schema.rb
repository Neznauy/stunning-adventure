...
ActiveRecord::Schema.define(version: 2024_03_06_154510) do
  ...
  create_table "prices", force: :cascade do |t|
    ...
    t.index "\"package\", \"strftime('%Y', created_at)\", \"municipality_id\"", name: "idx_on_package_strftime('%Y', created_at)_municipal_5514c8904e"
